...
class _ActivitiesState extends State<Activities> {
  ...
  List coursesList = [];
  List rate = [];
  var activitiesCourses;

  @override
  void initState() {
    adminBloc = BlocProvider.of<AdminBloc>(context);
    adminBloc.add(
      GetActivitiesCoursesEvent(),
    );
    super.initState();
  }
    ...
    return Scaffold(
      ...
      body: BlocListener<AdminBloc, AdminState>(
        listener: (context, state) {
          ...
          } else if (state is GetActivitiesCoursesSuccessState) {
            setState(() {
              activitiesCourses = state.activitiesCourses;
            });
          }
        },
        child: StreamBuilder<QuerySnapshot>(
          stream: activitiesCourses,
