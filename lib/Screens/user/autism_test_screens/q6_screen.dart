...
import 'package:autism101/Screens/user/autism_test_screens/q7_screen.dart';
import 'package:autism101/Screens/user/autism_test_screens/q5_screen.dart';

class TestQ6 extends StatefulWidget {
  final prevDegree;
  TestQ6({this.prevDegree});
  @override
  State<TestQ6> createState() => _TestQ6State();
}

class _TestQ6State extends State<TestQ6> {
