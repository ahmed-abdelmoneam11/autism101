...
import 'package:autism101/Screens/user/autism_test_screens/q6_screen.dart';

class TestQ7 extends StatefulWidget {
  final prevDegree;
  TestQ7({this.prevDegree});
  @override
  State<TestQ7> createState() => _TestQ7State();
}

class _TestQ7State extends State<TestQ7> {
