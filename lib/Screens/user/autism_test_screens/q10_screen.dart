...
import 'package:autism101/Screens/user/autism_test_screens/result_screen.dart';
import 'package:autism101/Screens/user/autism_test_screens/q9_screen.dart';

class TestQ10 extends StatefulWidget {
  final prevDegree;
  TestQ10({this.prevDegree});
  @override
  State<TestQ10> createState() => _TestQ10State();
}

class _TestQ10State extends State<TestQ10> {
