...
import 'package:autism101/Screens/user/autism_test_screens/q10_screen.dart';
import 'package:autism101/Screens/user/autism_test_screens/q8_screen.dart';

class TestQ9 extends StatefulWidget {
  final prevDegree;
  TestQ9({this.prevDegree});
  @override
  State<TestQ9> createState() => _TestQ9State();
}

class _TestQ9State extends State<TestQ9> {
